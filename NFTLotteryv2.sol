...
contract NFTLottery is  IERC721Receiver, Ownable {
    ...
    function PickWinner() external  {
        require(resultTime <= block.timestamp, "WINNING TIME NOT REACHED" );
       ...
       winnerAddress = stakers[pickWinner] ; 
       winnerAnnounced = true;
        
       nftredeem.safeTransferFrom(address(this), winnerAddress, nftId);    
       emit winner(winnerAddress, nftId);
    }
    ...
    function startStaking(uint256 _resultTime) external onlyOwner {
        staking = true;
